    ...
    <div>
      ...
      <form className="p-10 bg-black absolute w-3/12 my-40 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-70">
        ...
        <input
          ...
          className="p-4 m-2 w-full bg-gray-900 bg-opacity-70 text-xl border border-white"
        />
        <input
          type="password"
          placeholder="Password"
          className="p-4 m-2 w-full bg-gray-900 bg-opacity-70 text-xl border[5px] border-white"
        />
