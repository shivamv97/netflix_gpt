...
const Login = () => {
  return (
    <div>
      ...
      <form className="p-10 bg-black absolute w-3/12 my-40 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-50">
        ...
        <input
          ...
          className="p-4 m-2 w-full bg-gray-700 bg-opacity-70 font-bold"
        />
