    ...
    <div>
      ...
      <form className="p-10 bg-black absolute w-3/12 my-40 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-70">
        ...
        <input
          ...
          className="p-4 mx-1 w-full bg-gray-900 bg-opacity-70 text-xl border border-gray-500 rounded"
        />
        {!isSignInForm && (
          <input
            type="text"
            placeholder="Name "
            className="p-4 my-3 w-full bg-gray-900 bg-opacity-70 text-xl border border-gray-500 rounded"
          />
        )}
        <input
          type="password"
          placeholder="Password"
          className="p-4 m-4 w-full bg-gray-900 bg-opacity-70 text-xl border border-gray-500 rounded"
        />
